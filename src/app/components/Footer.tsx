      ...
      <div className="mx-auto px-4" style={{ maxWidth: '980px' }}>
        <div className="flex justify-center space-x-4 md:space-x-6 py-4">
          <div className="relative group">
            ...
            <span className="absolute bottom-full left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">Coming Soon</span>
          </div>
