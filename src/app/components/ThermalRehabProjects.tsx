...
export default function ThermalRehabProjects() {
    ...
    return (
        <section className="max-w-5xl mx-auto px-8 py-16">
            <div className="mb-24">
                <p className="text-sm font-semibold tracking-wider text-slate-600 uppercase mb-3">Residential Infrastructure</p>
                <h2 className="text-3xl font-bold text-gray-900 mb-4">Thermal Rehabilitation Projects</h2>
                <p className="text-sm text-gray-600 max-w-3xl">Strategic initiative for improving energy efficiency in residential buildings across Reșița, focusing on modernizing apartment blocks to enhance comfort and reduce energy consumption for residents.</p>
            </div>
            ...
            {projects.map((project) => (
                <div key={project.id} className="grid grid-cols-[1fr_1.2fr] gap-8 mb-16">
                    <div className="grid gap-8">
                        ...
                        <div>
                            <h3 className="text-3xl font-semibold text-gray-900 mb-4 leading-tight pt-4">
                                {project.title}
                            </h3>
                            <p className="text-gray-600 leading-relaxed mb-2">
                                {project.description}
                            </p>
                            <p className="text-gray-600 leading-relaxed mb-2">The thermal rehabilitation project aims to address these issues by enhancing the thermal properties of such buildings, thereby reducing energy consumption and improving indoor comfort for residents.</p>
                    ...
                    <div className="row-span-2 p-8 bg-gray-50 rounded-lg text-gray-700 leading-relaxed text-sm">
                       <h1 className='font-bold pr-24 text-3xl pb-10'>{project.detailsTitle}</h1> 
                        {project.details}
                        
                        <div className="mt-8 mb-8">
                            <h4 className="font-semibold text-lg mb-4">Overview of the Rehabilitation Program</h4>
                            <div className="space-y-6">
                                ...
                                <div>
                                    <h5 className="font-medium mb-2">Scope of Work:</h5>
                                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <p className=''>This program has significantly impacted residents by improving living conditions and reducing energy costs.</p>
                    </div>
                </div>
            ))}
        </section>
