    ...
    return (
        <section className="max-w-5xl mx-auto px-8 py-16">
            <div className="mb-24">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">Military College Development</h2>
                <p className="text-sm text-white/70 max-w-3xl">Strategic development of military educational facilities to support the next generation of military officers with modern infrastructure and training facilities.</p>
            </div>
                    ...
                    <div className="row-span-2 p-8 bg-white/5 rounded-lg text-white/70 leading-relaxed text-sm">
                       <h1 className='font-bold pr-24 text-3xl text-white pb-10'>{project.detailsTitle}</h1> 
                        ...
                        <div className="mt-8 mb-8">
                            <h4 className="font-semibold text-lg text-white mb-4">Project Overview</h4>
                            <div className="space-y-6">
                                ...
                                <div>
                                    <h5 className="font-medium text-white mb-2">Development Scope:</h5>
                                    <ul className="list-disc pl-5 space-y-2">
                                    ...
                                    <div className="absolute inset-0 flex items-center">
                                        {currentImage > 0 ? (
                                            <button
                                                ...
                                                className="ml-4 bg-black/20 hover:bg-black/40 p-2 rounded-full shadow-lg transition-colors text-white"
                                        ...
                                        {currentImage < galleryImages.length - 1 ? (
                                            <button
                                                onClick={nextImage}
                                                className="ml-auto mr-4 bg-black/20 hover:bg-black/40 p-2 rounded-full shadow-lg transition-colors text-white"
